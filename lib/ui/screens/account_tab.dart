...
import 'package:gestor_passwords/data/account_logo.dart';
import 'package:gestor_passwords/data/model/records_model.dart';
import 'package:gestor_passwords/data/my_encryption.dart';
...
class _AccountsTabState extends State<AccountsTab> {
  ...
  String noDataText = Strings.noData;
  String query = '';
  bool noData = true;
  int countSeacrh = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        backgroundColor: BrandColor.softPink,
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
